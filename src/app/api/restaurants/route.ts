...
export async function GET(request: NextRequest) {
    try {
        ...
        let result: TransformedRestaurant[] = baseRestaurants.map((restaurant) => {
            ...
            // ⚡ Bolt: Use a single-pass loop to aggregate branch metrics instead of chaining .map() and .filter() calls.
            // This eliminates multiple O(N) intermediate array allocations and redundant iterations.
