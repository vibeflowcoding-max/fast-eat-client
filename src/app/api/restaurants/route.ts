...
export async function GET(request: NextRequest) {
    try {
        ...
        let result: TransformedRestaurant[] = baseRestaurants.map((restaurant) => {
            ...
            // Eliminates 5 independent O(N) chained array maps and filters per restaurant, drastically reducing memory footprint.
            ...
            const resolvedReviewCount = reviewCountSum > 0 ? reviewCountSum : (restaurantReviewCount ?? 0);
            ...
            const derivedFee = estimatedFeeCount > 0 ? estimatedFeeSum / estimatedFeeCount : null;
